...
class UI {
    ...
    static buildTournamentPage(tournament: Tournament) {
    ...
    static buildTeamsSection(tournament: Tournament, parentElement: Element) {
    ...
    static addTeamToTournamentPage(team: Team, parentElement: Element) {
